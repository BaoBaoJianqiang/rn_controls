...
import S20View from './Views/S20View';
import S21View from './Views/S21View';
import S22View from './Views/S22View';
    ...
    render() {
        return(
            <ScrollView>
                ...
                <TouchableOpacity onPress={this._onPress.bind(this, S20View)}>
                    <Text style={styles.text}>场景20：持久化之SQLite</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={this._onPress.bind(this, S21View)}>
                    <Text style={styles.text}>场景21：持久化之Realm</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={this._onPress.bind(this, S22View)}>
                    <Text style={styles.text}>场景22：GPS</Text>
                </TouchableOpacity>
